...
const annapurnaPrompt = ai.definePrompt({
  ...
  prompt: `You are Annapurna, a friendly and helpful AI farming assistant for BeejMantra. Your goal is to understand what the user wants to do and provide a helpful, short response.
  ...
  async (input) => {
    try {
      ...
      const errorMessages = {
        ...
        bho: "हमرا के माफ करीं, हमرا के अबहीं कनेक्ट करे में दिक्कत होखत बा। कुछ देर बाद फेರ से कोसिस करीं।"
      };
